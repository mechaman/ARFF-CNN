...
class myUnet(object):
	...
	#binary sigmoid output for masking.
        ...
        model.compile(optimizer = Adam(lr = 1e-4), loss = dice_coef_loss, metrics = ['mse', dice_coefficient])
    ...
    def train3(self):
        ...
        #else:
        model = self.get_unet()
        model_checkpoint = ModelCheckpoint('unet_dice.hdf5', monitor='dice_coefficient_loss',verbose=1,
                                           save_best_only=True)
