...
for side_file_x,side_file_y in side_files:	
	...
	if patient in test_patients:		
		test_path_y = side_file_x.replace(input_data_dir, output_data_dir)	
...
for top_file_x,top_file_y in top_files:	
	...
	if patient in test_patients:		
		test_path_y = top_file_x.replace(input_data_dir, output_data_dir)	
...
for back_file_x,back_file_y in back_files:	
	...
	if patient in test_patients:		
		test_path_y = back_file_xñ.replace(input_data_dir, output_data_dir)	
